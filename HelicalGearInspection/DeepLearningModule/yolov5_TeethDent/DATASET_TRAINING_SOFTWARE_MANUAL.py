...
"Background-color:rgb(162, 182, 255);")
        ...
        self.pushButton_2.clicked.connect(self.separate_images)
...
"Background-color:rgb(162, 182, 255);")
        ...
        self.pushButton_4.clicked.connect(self.process_folder)
...
"font: 87 20pt \"Segoe UI Black\";")
    ...
    def copy_files(self):
        ...
        destination_path_1 = 'D:/New folder/HelicalGearInspection/HelicalGearInspection/DeepLearningModule/yolov5_TeethDent/yolov5'  # Replace with the first destination folder path
        destination_path_2 = 'D:/New folder/HelicalGearInspection/HelicalGearInspection/DeepLearningModule/yolov5_TeethDent/yolov5/data'  # Replace with the second destination folder path
    ...
    def process_folder(self):
        ...
        input_folder = str(folder_dialog.getExistingDirectory(None, "Select Directory"))
...
# Create an instance of the class and call the function   
    ...
    def send_weights_to_fixed_folder(self):
        try:
            destination_path = r"D:\New folder\HelicalGearInspection\HelicalGearInspection\DeepLearningModule\yolov5_TeethDent\yolov5"  # Replace this with your fixed destination path
    ...
    def run_yolov5_training(self):
        environment_name = "dataset_training"
